...
{
    defineTypeNameAndDebug(explicitSharp, 0);
    addToRunTimeSelectionTable(phaseChangeTwoPhaseMixture, explicitSharp, components);
}
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::phaseChangeTwoPhaseMixtures::explicitSharp::explicitSharp
(
...
Foam::phaseChangeTwoPhaseMixtures::explicitSharp::mDotAlphal() const
{
...
Foam::Pair<Foam::tmp<Foam::volScalarField> >
Foam::phaseChangeTwoPhaseMixtures::explicitSharp::mDotP() const
{
	return Pair<tmp<volScalarField> >
	(
...
Foam::Pair<Foam::tmp<Foam::volScalarField> >
Foam::phaseChangeTwoPhaseMixtures::explicitSharp::mDotT() const
{
	return Pair<tmp<volScalarField> >
	(
...
void Foam::phaseChangeTwoPhaseMixtures::explicitSharp::correct()
{
...
bool Foam::phaseChangeTwoPhaseMixtures::explicitSharp::read()
{
